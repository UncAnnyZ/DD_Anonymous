    ...
    [
      _c("canvas", {
        style: _vm._$s(
          1,
          "s",
          "width: 750rpx; height:" + _vm.canvasHight + ";"
        ),
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {\n      canvasHight: \"100vh\" };\n\n  },\n  onShow: function onShow() {\n    var info = uni.getStorageSync(\"save_bookmark\");\n    __f__(\"log\", info, \" at pages/index/save.vue:17\");\n    this.produce(info);\n  },\n  methods: {\n    produce: function produce(info) {\n      __f__(\"log\", \"开始绘画\", \" at pages/index/save.vue:22\");\n      var ctx = uni.createCanvasContext('myCanvas');\n\n      var t = new Date(info.time).toDateString();\n      __f__(\"log\", t, \" at pages/index/save.vue:26\");\n      var tArray = t.split(\" \");\n      __f__(\"log\", tArray, \" at pages/index/save.vue:28\");\n      __f__(\"log\", tArray[0], \" at pages/index/save.vue:29\"); // Mon/Tues/Wed/Thur/Fri/Sat/Sun\n      __f__(\"log\", tArray[1], \" at pages/index/save.vue:30\"); // Jan/Feb/Mar/Apr/May/Jun/Jul/Aug/Sept/Oct/Nov/Dec\n      __f__(\"log\", tArray[2], \" at pages/index/save.vue:31\"); // 01-31\n      __f__(\"log\", tArray[3], \" at pages/index/save.vue:32\"); // 2021\n\n      // 记录高度\n      var height = 20;\n\n      // 日\n      ctx.setFontSize(50);\n      ctx.fillText(tArray[2], 10, height + 40);\n      // 月·年份\n      ctx.setFontSize(18);\n      ctx.fillText(tArray[1] + \" · \" + tArray[3], 100, height + 40);\n\n      height += 50;\n      // 画图\n      // 按比例缩放\n      ctx.drawImage(info.img.path, 10, height, info.img.width * info.img.Wmul, info.img.height * info.img.Hmul); // drawImage(dx, dy, dWidth, dHeight)\n\n      height += info.img.height * info.img.Hmul; // 图高 + 自身处高度\n\n      // 记本\n      var length = info.book.length + 1; // 加的数为 = 20为中轴 ± 1\n      ctx.setFontSize(15); // 右边距 = 375(px) - 串长 * 字的大小\n      ctx.fillText(info.book, 385 - length * 15, height + 20 + 2); // 图高 + 字高 + 空行高度\n\n      height += 35; // 35 = 15↑ + 20↓ (字高)\n\n      // 文案\n      var arr = this.getTextArray(info.text);\n      ctx.setFontSize(18);\n      for (var i = 0; i < arr.length; i++) {\n        ctx.fillText(arr[i], 10, height + (18 + 20) * (i + 1)); // 35=20+15(字高) 20+5(字高 + 行间距)\n      }\n\n      height = height + (20 + 20) * arr.length;\n      length = info.nickname.length + 1;\n\n      // 署名\n      ctx.fillText(info.nickname, 385 - length * 18, height); // 35=20+15(字高) 20+5(字高 + 行间距)\n\n      height = height + 15 + 20 + 20;\n\n      // 落尾\n      ctx.setFontSize(15);\n      ctx.fillText(\"D/D/D/D\", 160, height);\n\n      // 加底边距\n      height += 20;\n      this.canvasHight = height + \"px\";\n\n      setTimeout(function () {\n        ctx.draw();\n      }, 2000);\n    },\n\n    getTextArray: function getTextArray(text) {\n      var arr = text.split(/[,.!，。！]/);\n      __f__(\"log\", arr, \" at pages/index/save.vue:88\");\n      return arr;\n    },\n\n    save: function save() {\n      uni.canvasToTempFilePath({\n        canvasId: \"myCanvas\",\n        success: function success(res) {\n          __f__(\"log\", res, \" at pages/index/save.vue:96\");\n\n          uni.saveImageToPhotosAlbum({\n            filePath: res.tempFilePath,\n            success: function success(ress) {\n              __f__(\"log\", ress, \" at pages/index/save.vue:101\");\n            } });\n\n        } });\n\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 28)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///98\n");
